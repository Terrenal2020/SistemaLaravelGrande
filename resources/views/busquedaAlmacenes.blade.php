...
<div>
    <div align="center">
        <h3> Datos de Busqueda de Almacen</h3>
        </div>
    ...
    <div class="card-header">
        <ul class="nav nav-tabs card-header-tabs" style="background-color: #FFFEE4;">
            ...
            <li  class="nav-item ml-auto">
                <form class="d-flex" action="{{ route('refrescarAlmacen') }}" method="post" >
                    @csrf
                    <input class="form-control me-2" type="search" placeholder="Almacen" aria-label="Search" name="nombre" id="nombre" >
...
<div align="center">
    ...
    <table class="table"  id="tabla-almacenes">
...
<tbody>
@foreach($registroDe as $almaceness)
    <tr>
