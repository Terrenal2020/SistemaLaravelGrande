...
<div>
    <div align="center">
        <h3> Datos de Categoria de Productos</h3>
        </div>
    ...
    <div class="card-header">
        <ul class="nav nav-tabs card-header-tabs" style="background-color: #FFFEE4;">
            ...
            <li  class="nav-item ml-auto">
                <form class="d-flex" action="{{ route('busquedaCategorias') }}" method="post" >
                    @csrf
                    <input class="form-control me-2" type="search" placeholder="Departamento" aria-label="Search" name="nombre" id="nombre" required>
...
<tbody>
@foreach($categoriaProductos as $categoriaProductoss)
    <tr>
