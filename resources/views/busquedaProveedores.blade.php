...
<div>
    <div align="center">
        <h3> Datos de Busqueda de Proveedores</h3>
        </div>
    ...
    <div class="card-header">
        <ul class="nav nav-tabs card-header-tabs" style="background-color: #FFFEE4;">
            ...
            <li  class="nav-item ml-auto">
                <form class="d-flex" action="{{ route('refrescarProveedores') }}" method="post" >
                    @csrf
                    <input class="form-control me-2" type="search" placeholder="Proveedor" aria-label="Search" name="nombre" id="nombre">
...
<tbody>
@foreach($registroDe as $proveedoress)
    <tr>
